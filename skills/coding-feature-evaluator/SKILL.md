...
description: Evaluate whether a completed feature or issue fix is actually done using a read-only skeptical review, deterministic checks, acceptance coverage review, and clear PASS/FAIL/BLOCKED output. Use after coding-feature-execute, coding-fix-issue, coding-auto-improve, or coding-autonomous-execute before marking work complete.
metadata:
