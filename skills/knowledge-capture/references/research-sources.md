...
Read [note-shapes.md](note-shapes.md) and use its exact note names and grounding rules.
...
1. Resolve `<skill-dir>` as the parent of this `references/` directory, containing the `knowledge-capture` entrypoint `SKILL.md`.
