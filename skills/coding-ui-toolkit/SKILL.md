...
4. Keep responsibilities clear: the coding lifecycle skills own engineering lifecycle and verification; `coding-frontend` owns repository implementation conventions; specialist skills own their techniques. Route non-application artifacts to their matching skills.
