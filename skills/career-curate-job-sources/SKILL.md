---
name: career-curate-job-sources
...
Build a current, deduplicated, ranked source plan for a person's actual search. The plan is an input to `$career-search-jobs`, not a list of vacancies.
