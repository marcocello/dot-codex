...
- In target app repos, `$HOME/.codex/scripts/gate` and
  `$HOME/.codex/scripts/acceptance --feature <FEATURE_DIR>` decide done.
- When editing this `dot-codex` config repo itself, do not run gate or feature acceptance unless
