...
3. Resolve event settings:
   ...
   - Preserve meaningful names and punctuation, normalize spacing around `&`, and apply obvious human capitalization. Example: `Use $app-photo-drop to start a 6-hour Rob&mary wedding photo drop` becomes `Rob & Mary Wedding`.
