---
name: frontend
description: Implement or refactor user-facing React/Next.js UI with strong layout, interaction, and visual quality while preserving repo conventions. Use only for frontend surface changes; do not use for backend-only or infrastructure tasks.
metadata:
